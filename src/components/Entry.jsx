  ...
  return (
    <article className="flex-shrink-0 bg-gray-100 text-gray-400 w-full flex flex-wrap justify-center items-center gap-8 p-8 rounded-lg">
      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        <a className="mt-4 text-center font-semibold text-white w-full text-xl px-4 py-2 bg-blue-600 rounded-full hover:bg-blue-900" href={googleMapsLink} target="_blank" rel="noopener noreferrer">Send Request</a>
